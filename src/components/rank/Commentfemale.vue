	...
	<div class="comment">
		<div>
			<ul class="left">
				...
				<li @click="xso()">好评榜</li>
				<li @click="xst()">热搜榜</li>
				<li @click="xsf()">VIP榜</li>
				<li @click="xsfive()">潜力榜</li>
				<li>留存榜</li>
				<li>完结榜</li>
				<li>圣诞榜</li>
				<li>掌阅榜</li>
...
<script>
	...
	export default {
		...
		created() {
			fetch(`/rank/54d43437d47d13ff21cad58b`).then(res => res.json())
				.then(data => {
					this.lists = data.ranking.books
				});
			fetch(`/rank/5a684551fc84c2b8efaab179`).then(res => res.json())
				.then(data => {
					this.listso = data.ranking.books
				});
			fetch(`/rank/5a684515fc84c2b8efaa9875`).then(res => res.json())
				.then(data => {
					this.listst = data.ranking.books
				});
			fetch(`/rank/57eb959df60eb7e21fb3a8b7`).then(res => res.json())
				.then(data => {
					this.listsf = data.ranking.books
				});
			fetch(`/rank/54d43709fd6ec9ae04184aa5`).then(res => res.json())
				.then(data => {
