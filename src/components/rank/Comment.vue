...
<script>
	...
	export default {
		...
		created() {
			...
			fetch(`/rank/5a6844f8fc84c2b8efaa8bc5`).then(res => res.json())
				.then(data => {
					this.listst = data.ranking.books
				});
			fetch(`/rank/54d42e72d9de23382e6877fb`).then(res => res.json())
				.then(data => {
					this.listsf = data.ranking.books
				});
			fetch(`/rank/564547c694f1c6a144ec979b`).then(res => res.json())
				.then(data => {
